import { HonorTile, NumberedTile, DragonTile, WindTile } from './tile-classes'
import { Chii, Pair, Pon, Kan } from './combinaison-classes'
    ...
    for (var i = 0; i < hand.combinaisons.length; i++) {
      ...
      if (combinaison instanceof Chii) {
        for (var j = 0; j < storedChiis.length; j++) {
          if (
            storedChiis[j].tiles[0].suit === combinaison.tiles[0].suit &&
 ...
 */
export function SanShokuDoujun () {
  YakuPattern.call(this)
 ...
 * Han: 1
 */
export function FanpaiSeatWind () {
  YakuPattern.call(this)
 ...
 * Han: 1
 */
export function FanpaiRoundWind () {
  YakuPattern.call(this)
 ...
 * Han: 1
 */
export function FanpaiDragonPon () {
  YakuPattern.call(this)
...
export function HaiteiRaoyue () {
  ...
  this.check = function (hand) {
    if (hand.winningType === 'tsumo' && hand.wonWithLastTile) {
      return 1
    }
    return 0
  }
...
export function HouteiRaoyui () {
  ...
  this.check = function (hand) {
    if (hand.winningType === 'ron' && hand.wonWithLastTile) {
      return 1
    }
    return 0
  }

...
test('pinfu (all chii / no point) valid hand', () => {
...
test('pinfu (all chii / no point) invalid hand with a dragon pair', () => {
...
test('pinfu (all chii / no point) invalid hand with a seat wind pair', () => {
...
test('pinfu (all chii / no point) invalid hand with a prevalent wind pair', () => {
...
test('pinfu (all chii / no point) invalid hand with a pon', () => {
...
test('pinfu (all chii / no point) invalid hand with a kan', () => {
...
test('pinfu (all chii / no point) invalid hand when open', () => {
...
test('pinfu (all chii / no point) invalid hand with an edge wait', () => {
...
test('pinfu (all chii / no point) invalid hand with a closed wait', () => {
...
test('pinfu (all chii / no point) invalid hand with a single wait', () => {
